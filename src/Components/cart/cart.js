  ...
  return (
    <>
      ...
      >
        ...
        <Offcanvas.Body>
          {total ? productList :(<div className="d-flex justify-content-center align-items-center flex-column mb-5">
            <FontAwesomeIcon style={{fontSize:"150px"}} icon={faBagShopping} />
            <span className="mt-4">
              Add Some Product to Continue
            </span>
          </div>) }
          {/* NO product Condition  */}
          <div className="d-flex justify-content-center  py-2">
            {" "}
            <Button variant="outline-primary"  disabled={!total}>Checkout</Button>{" "}
          </div>
        </Offcanvas.Body>
      </Offcanvas>
    </>
